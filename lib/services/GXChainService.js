...
import {Aes, ChainStore, FetchChain, hash, TransactionBuilder, TransactionHelper} from 'gxbjs';
...
const decrypt_msg = function (msg, private_key, public_key_string) {
    let base64Str = Aes.decrypt_with_checksum(private_key, public_key_string || private_key.toPublicKey().toPublicKeyString(), null, new Buffer(msg, 'base64')).toString('utf-8');
