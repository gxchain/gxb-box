        ...
        <div class="loaded-container" v-if="loaded">
            <div class="merchant" v-if="account_type === 'merchant'">
                <Form ref="formValidate1" :model="formValidate1" :rules="ruleValidate1" :label-width="100">
                    <FormItem label="账号" prop="account_name">
                        <i-input readonly v-model="formValidate1.account_name" placeholder="sample_user"
                    ...
                    <FormItem label="私钥" prop="private_key">
                        ...
                        <i-input :type="show_type" readonly v-model="formValidate1.private_key"
                               placeholder="请输入账户私钥"></i-input>
                    </FormItem>
                    <FormItem label="回调地址" prop="callback_url">
                        <i-input v-model="formValidate1.callback_url"
                               placeholder="http://localhost:3000/demo/callback"></i-input>
                    </FormItem>
            ...
            <div class="datasource" v-if="account_type === 'datasource'">
                <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate2" :label-width="100">
                    <FormItem label="账号" prop="account_name">
                        <i-input readonly v-model="formValidate2.account_name" placeholder="sample_user"
                               class="account_input"></i-input>
                    </FormItem>
                    <FormItem label="私钥" prop="private_key">
                        <div @click="changeShowType()">
                        ...
                        <i-input :type="show_type" readonly v-model="formValidate2.private_key"
                               placeholder="请输入账户私钥"></i-input>
                    </FormItem>
                    <div class="split-line"><span class="txt">数据源（出售数据）</span></div>
                    <FormItem label="接口地址" prop="service">
                        <i-input v-model="formValidate2.service" placeholder="http://localhost:3000/demo/call"></i-input>
                    </FormItem>
                    <FormItem
                    ...
                    <FormItem>
                        <Row>
                            <i-col span="12">
                                <i-input v-model="product_id" placeholder="请输入产品ID"></i-input>
                            </i-col>
                    ...
                    <div class="merchant_config" v-if="is_merchant_open">
                        ...
                        <FormItem label="回调地址" prop="callback_url">
                            <i-input v-model="formValidate2.callback_url"
                                   placeholder="http://localhost:3000/demo/callback"></i-input>
                        </FormItem>
                        <FormItem label="请求超时/毫秒" prop="privacy_request_timeout">
                            <InputNumber v-model="formValidate2.privacy_request_timeout"
                                         placeholder="120000"></InputNumber>
                        </FormItem>
                        <FormItem label="默认超时/毫秒" prop="default_timeout">
