...
<template>
    <div class="account-setting">
        <Tabs value="merchant" :animated="false">
            <TabPane label="商户" name="merchant">
                <Alert type="info">已有账号的用户请填写相关信息，若无请先创建账号</Alert>
                <Form ref="formValidate1" :model="formValidate1" :rules="ruleValidate1" :label-width="80">
                    ...
                    <FormItem>
                        ...
                        <Button type="ghost" @click="sign">创建账号</Button>
                    </FormItem>
                </Form>
            </TabPane>
                ...
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        this.$http({
                            ...
                            localStorage.setItem('init_step',1);
